...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        ...
        return "The information about the stocks and the company will be displayed here.", "https://raw.githubusercontent.com/Konteya/stock-forecast/main/assets/25-stocks-that-can-offer-up-to-48-returns-over-12-months-according-to-stock-reports-plus.png", "Stocks Forecast", None, None, None
